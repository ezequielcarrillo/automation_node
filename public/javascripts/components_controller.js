 ...
 */
angular.module('automation').controller('Components', function ($scope, $http, shared) {
    ...
    $scope.saveComponentDetails = function(){

        var elementId = shared.selectedId();
        var comments =$('.comment').val();

        $http
            .post('/saveComponentDetails', {
    ...
    $scope.saveComponentParameter = function(){
    ...
    $scope.deleteAuto = function($event){
        ...
        $http
            .post('/deleteComponentAutomation', {
    ...
    $scope.saveComponentAutomation = function(){
    ...
    $scope.saveComponentScript = function(){

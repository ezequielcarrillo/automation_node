...
var TestBuilder = function() {
    ...
    var testQueryBuilder = function(selectedid, suite_execution_id) {
...
*/
    ...
    var test_runner_service = function(test, test_id, suite_execution_id) {
        /*
            libs = getLibs()# uri = URI('http://192.168.7.168:4568/runTest')

            uri = URI('http://localhost:4568/runTest')
